...
public abstract class PreparedStatementLogging<O extends Operational, G extends InvokeAggregator, D> extends ObjectProxyLogging<O, G, D> {

    public static class Default<D> extends PreparedStatementLogging<Operational.Default, InvokeAggregator.Default_intoLog, D> {

        public Default(String sql) {
            super(Operational.DEFAULT_OPTIONS_INSTANCE, LoggingService.DEFAULT_INSTANCE, sql);
        }
