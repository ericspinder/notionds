...
public class ConnectionService<O extends Options, NC extends NotionConnection, DM extends DelegateMapper<O, NC, EH>, EH extends ExceptionHandler> {
    ...
    public NotionConnection createNotionConnection(Connection connection) {
