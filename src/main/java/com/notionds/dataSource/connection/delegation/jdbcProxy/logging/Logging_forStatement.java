...
public class Logging_forStatement<O extends Options, IA extends InvokeAccounting, IG extends InvokeAggregator<O, IA>, IL extends InvokeLibrary<O, IA, IG>> extends Logging_forDbObject<O, IA, IG, IL> {

    public static class Default<O extends Options, IA extends InvokeAccounting, IG extends InvokeAggregator<O, IA>, IL extends InvokeLibrary<O, IA, IG>> extends Logging_forStatement<O, IA, IG, IL> {
